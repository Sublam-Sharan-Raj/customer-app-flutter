...
abstract class _Auth implements Auth {
  const factory _Auth(
      ...
      @JsonKey(name: "user") final User? user}) = _$AuthImpl;
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, mobile: $mobile, email: $email, role: $role, firstName: $firstName, lastName: $lastName)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, mobile, email, role, firstName, lastName);
